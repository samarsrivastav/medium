...
```bash
git clone https://github.com/samarsrivastav/medium
```
...
4. Create a `.env` and `wrangler.toml` file inside backend.
   ...
   - inside `.env` - Use [AIVEN](https://aiven.io/) or [neon](neon.tech) postgres database
    ```
...
Access in your browser at http://localhost:3000 or the api in the /backend/readme.md
